...
#Set variables
HELPFILE = os.path.expanduser(dir_user + "/.wallpaper/help.txt")
# DEFAULT = "/usr/share/wallpaper-antix/wallpaper-none.png"
USERFOLDER = os.path.expanduser(dir_user + "/.wallpaper")
SAVED = os.path.expanduser(dir_user + "/.wallpaper/lightdm")
SAVEDSESSION = os.path.expanduser(dir_user + "/.wallpaper/session")
SETTYPE = os.path.expanduser(dir_user + "/.wallpaper/set-type")
COLOR = os.path.expanduser(dir_user + "/.wallpaper/color")
BACKFOLDER = os.path.expanduser(dir_user + "/.wallpaper/background_folder")
...
class Base:
    ...
    def __init__(self):
      ...
      self.window.set_title("Login Screen Wallpaper Wizard")
      ...
      self.okbutton.connect("clicked", self.change_wallpaper_lightdm) # Call function set
